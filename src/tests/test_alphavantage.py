...
class AlphavantageTestCase(unittest.TestCase):
    ...
    def test_process_income_statement(self):
        ...
        self.assertGreater(
            ic_statement["annualReports"].index[-1],
            ic_statement["annualReports"].index[0],
        )
        # Check oldest date is first record
        self.assertGreater(
            ic_statement["quarterlyReports"].index[-1],
    ...
    def test_process_earnings(self):
        ...
        # Check oldest date is first record
        self.assertGreater(earnings["annualEarnings"].index[-1], earnings["annualEarnings"].index[0])
        # Check oldest date is first record
        self.assertGreater(
            earnings["quarterlyEarnings"].index[-1],
    ...
    def test_process_cash_flow(self):
        ...
        # Check oldest date is first record
        self.assertGreater(cash_flow["annualReports"].index[-1], cash_flow["annualReports"].index[0])
        # Check oldest date is first record
        self.assertGreater(
            cash_flow["quarterlyReports"].index[-1],
        ...
        self.assertIn(
            ...
            cash_flow["quarterlyReports"].keys(),
        )
    ...
    def test_process_balance_sheet(self):
        ...
        # Check oldest date is first record
        self.assertGreater(
            balance_sheet["annualReports"].index[-1],
            balance_sheet["annualReports"].index[0],
        )
        # Check oldest date is first record
        self.assertGreater(
            balance_sheet["quarterlyReports"].index[-1],
        ...
        self.assertIn(
            ...
            balance_sheet["annualReports"].keys(),
        )
        ...
        self.assertIn(
            "cashAndCashEquivalentsAtCarryingValue",
            balance_sheet["quarterlyReports"].keys(),
        )
    ...
    def test_process_prices(self):
        ...
        # Check oldest date is first record
        self.assertGreater(prices.index[-1], prices.index[0])
